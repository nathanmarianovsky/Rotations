...
console.log("Rotating the vector, (" + vector[0] + "," + vector[1] + "," + vector[2] + "), about the axis, (" + axis[0] + "," + axis[1] + "," + axis[2] + "), with a " + alpha + " degree angle provides the result: (" + output[0] + "," + output[1] + "," + output[2] + ").");